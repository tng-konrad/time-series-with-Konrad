...
A model that never saw my data just beat one trained on it. By 17%. In 0.3 seconds, on a laptop.
...
🚀 **TimesFM 2.5** (Google, 200M params): the patched decoder — 120 two-week forecasts in 6.3s, zero training, with uncertainty bands that fan out like a textbook
